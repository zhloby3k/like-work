...
public class PartAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        Integer color = Color.parseColor("#EF9A9A");
        Integer status = cursor.getInt(cursor.getColumnIndex(LikeWorkContract.PartEntry.COLUMN_STATUS));
        switch (status) {
            case 2: color = Color.parseColor("#A5D6A7"); break;
            case 3: color = Color.parseColor("#FFE082"); break;
            case 4: color = Color.parseColor("#81D4FA"); break;
            case 5: color = Color.parseColor("#B39DDB"); break;
        }
